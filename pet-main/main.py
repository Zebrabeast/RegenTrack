...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default="/home/data_SSD/zk/MOT17", type=str)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(f"[Rank {utils.get_rank()}] Start epoch {epoch}")
        
        # save checkpoint
        checkpoint_paths = [output_dir / 'checkpoint.pth']
        for checkpoint_path in checkpoint_paths:
            print(f"[Rank {utils.get_rank()}] Saving checkpoint to {checkpoint_path}")
